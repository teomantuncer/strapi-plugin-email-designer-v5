...
export const isValidEmailSchema = string().test("is-valid-email", "Invalid email address", (value) => {
  return isValidEmail.test(value);
});
export const isTemplateReferenceIdSchema = number().required().label("Template Reference Id").min(1);
